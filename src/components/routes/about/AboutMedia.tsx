      ...
      <article className="w-11/12 mx-auto py-16" id="main-cards">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
          <div className="relative mx-auto w-full h-full">
            <img className="w-full h-full object-cover" src={VideoImg} alt="" />
            <a
              href="#"
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              generation of readers. Through decades of connecting readers with
              life-changing books, we've built more than a bookstore - we've
              created a literary home for our community.
            </p>
